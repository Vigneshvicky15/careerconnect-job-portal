      ...
      <form onSubmit={handleApplyFilters} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800 px-3 py-2.5 rounded-xl text-xs text-slate-800 dark:text-slate-200 outline-none"
          >
